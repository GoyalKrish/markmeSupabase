...
class _ActiveLobbyScreenState extends State<ActiveLobbyScreen> {
  ...
  Future<void> _shareLobbyData() async {
    ...
    final exportType = await showDialog<String>(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Text(
          'Select the preferred attendance export format:',
          style: GoogleFonts.inter(
              color: MarkMeTheme.primaryWhite.withOpacity(0.8), fontSize: 14),
        ),
        actions: [
          Row(
            ...
            children: [
                  ...
                  child: Row(
                    ...
                    children: [
                      Icon(Icons.description,
                          size: 20, color: MarkMeTheme.darkBackground),
                      SizedBox(width: 8),
                      Text(
                        'Export',
                        style: GoogleFonts.inter(
              ...
              Expanded(
                child: ElevatedButton(
                  onPressed: () => Navigator.pop(context, 'ezone'),
                  style: ElevatedButton.styleFrom(
                      backgroundColor: MarkMeTheme.surfaceDark,
                      padding: EdgeInsets.symmetric(vertical: 14),
                      side: BorderSide(
                  ...
                  child: Row(
                    ...
                    children: [
                      Icon(Icons.cloud_upload,
                          size: 20, color: MarkMeTheme.primaryYellow),
                      SizedBox(width: 8),
                      Text(
                        'Upload',
                        style: GoogleFonts.inter(
    ...
    try {
      ...
      final file = File(
          '${directory.path}/${sanitizedName}_attendance$fileNameSuffix.csv');
  ...
  String _generateEzoneCsvContent(
